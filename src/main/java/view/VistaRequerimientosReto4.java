...
public class VistaRequerimientosReto4 extends JFrame{
    ...
    public VistaRequerimientosReto4(){
        ...
        setVisible(true);
        Image icono = Toolkit.getDefaultToolkit().getImage("mistic.png");
        setIconImage(icono);
        ...
        JLabel lbltitulo = new JLabel("Reto 5 Ciclo 2 UTP-MisiónTIC 2022 Ruta 2");
        ...
        JLabel lblautor = new JLabel("Alvaro Alexander Ordóñez Chaves");
        lblautor.setBounds(28, 34, 737, 16);
        contentPane.add(lblautor);
        lblautor.setFont(new Font("Tahoma",Font.BOLD,15));
        lblautor.setHorizontalAlignment(JLabel.CENTER);
